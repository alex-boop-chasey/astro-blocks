 ...
 * ============================================================================
 *
 * Core utilities for optimizing images in Astro projects. Handles both local
 * Astro assets and external CDN images with responsive srcset generation.
 *
 * FEATURES:
 * - Dual optimizer support (Astro built-in + Unpic for external images)
 ...
 *
 * LAYOUT MODES:
 * - fixed: Same width at all screen sizes
 * - constrained: Responsive with max-width constraint
 * - fullWidth: 100% screen width at all sizes
 * - cover: Fills container (object-fit: cover)
 * - responsive: Responsive with aspect ratio preservation
 * - contained: Fits within container (object-fit: contain)
 *
 * OPTIMIZERS:
 * - astroAssetsOptimizer: For local images in ~/assets/images/
 * - unpicOptimizer: For external CDN images (Pixabay, Unsplash, etc.)
 *
 * NOTE: This utility is based on the AstroWind template's image optimization system.
 * ============================================================================
 */
